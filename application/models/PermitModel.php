...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    class PermitModel extends MY_Model {
        ...
        function getDataPermit ($filter = NULL, $filter_key = NULL, $limit = NULL, $field_target = NULL) {
        ...
        function updateDataPermit ($data, $findByValue = '') {
			$findBy = 'id';
            $query = [];
        ...
        function deleteDataPermit ($field_name, $field_value) {
