...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    class FileUploadModel extends MY_Model {
        private $tableName = 'file_upload';

        function __construct(){
            parent::__construct();
        }

        function addDataFileUpload ($data) {
        ...
        function getDataFileUpload ($filter = NULL, $filter_key = NULL, $limit = NULL, $field_target = NULL) {
        ...
        function updateDataFileUpload ($data, $findByValue = '') {
			$findBy = 'id';
            $query = [];
        ...
        function deleteDataFileUpload ($field_name, $field_value) {
