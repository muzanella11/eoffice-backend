...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    class DivisionModel extends MY_Model {
        private $tableName = 'division';

        function __construct(){
            parent::__construct();
        }

        function addDataDivision ($data) {
        ...
        function getDataDivision ($filter = NULL, $filter_key = NULL, $limit = NULL, $field_target = NULL) {
        ...
        function updateDataDivision ($data, $findByValue = '') {
			$findBy = 'id';
            $query = [];
        ...
        function deleteDataDivision ($field_name, $field_value) {
