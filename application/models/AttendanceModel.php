...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    class AttendanceModel extends MY_Model {
        ...
        function addDataAttendance ($data) {
        ...
        function getDataAttendance ($filter = NULL, $filter_key = NULL, $limit = NULL, $field_target = NULL) {
        ...
        function updateDataAttendance ($data, $findByValue = '') {
			$findBy = 'id';
            $query = [];
        ...
        function deleteDataAttendance ($field_name, $field_value) {
