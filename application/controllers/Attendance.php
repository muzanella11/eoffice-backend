...
class Attendance extends RestManager {
    ...
    public function index_post()
    {
        ...
        $dataModel = [
            [
                ...
                'dataMaster' => [
					'signin_date' => $this->post('signinDate'),
    ...
    public function index_put()
    {
		...
		$dataMaster = [
			'signin_date' => $this->put('signinDate'),
	...
	public function report_get()
    {
        ...
        $dataView = [
            ...
            'titleContent' => 'Laporan Data Attendance',
    ...
    public function ping_post() 
    {
        $data = [
            'status' => 'Ok',
            'messages' => 'Hello guys post attendance :)'
        ];
