...
class Task extends RestManager {
        ...
        $dataModel = [
            [
                ...
                'dataMaster' => [
					...
					'assignee_to' => $this->post('assigneeTo'),
					'priority' => $this->post('priority'),
					'deadline_date' => $this->post('deadlineDate'),
					'task_status' => $this->post('taskStatus'),
    ...
    public function index_put()
    {
		...
		$dataMaster = [
			...
			'assignee_to' => $this->put('assigneeTo'),
			'priority' => $this->put('priority'),
			'deadline_date' => $this->put('deadlineDate'),
			'task_status' => $this->put('taskStatus'),
	...
	public function report_get()
    {
        ...
        $dataView = [
            ...
            'titleContent' => 'Laporan Data Task',
